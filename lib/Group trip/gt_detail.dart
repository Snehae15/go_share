                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          widget.starting_point.toUpperCase(),
                          style: TextStyle(
                            fontSize: 27,
                            fontFamily: 'Times New Roman',
                            fontWeight: FontWeight.bold,
                        ...
                        Text(
                          widget.vehicle_type.toUpperCase(),
                          style: TextStyle(
                            fontSize: 20,
                            fontFamily: 'Times New Roman',
                            fontWeight: FontWeight.w500,
                        ...
                        ElevatedButton(
                          ...
                          onPressed: () {
                            _makePhoneCall(widget.mobile_no);
                          },
                          child: Text('Contact'),
                        ),
                      ],
